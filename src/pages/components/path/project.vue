        ...
        <div v-for="(p, index) in arr" :key="index">
            <el-row>
                ...
                <el-col class="tech" :span="16">
                    <span class="tech" v-for="(t, i) in p.t" :key="i"><span v-if="i != 0">-</span><span class="t">{{t}}</span>
                    </span>
                </el-col>
            </el-row>
            <p>{{p.note}}</p>
        ...
        data() {
            return {
                arr: [{
                    ...
                    name: 'tpcloud',
                    note: 'tplink 云摄像头门户网站',
                    t: ['jquery', 'bootstrap', 'fis3', 'requireJs']
                }, {
                    name: 'xAjax',
                    note: '多客户端环境跨域请求工具',
                    t: ['jquery']
